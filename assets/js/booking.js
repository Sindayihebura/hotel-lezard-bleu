...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (bookingForm) {
    bookingForm.addEventListener('submit', async (e) => {
      ...
      try {
        const response = await fetch(`/api/check_availability.php?checkin=${encodeURIComponent(dateArrivee)}&checkout=${encodeURIComponent(dateDepart)}&adults=${encodeURIComponent(nbPersonnes)}`);
